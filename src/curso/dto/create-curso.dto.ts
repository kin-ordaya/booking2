...
export class CreateCursoDto {
  ...
  @MaxLength(20, {
    message: 'El campo codigo no puede tener mas de 20 caracteres',
  })
  codigo: string;
  ...
  @MaxLength(20, {
    message: 'El campo codigo_cruzado no puede tener mas de 20 caracteres',
  })
  ...
  @MaxLength(100, {
    message: 'El campo descripcion no puede tener mas de 100 caracteres',
  })
  descripcion?: string;
